...
from services.chat_service import get_transcriptions_by_id_club,get_context_chat_messages, chat_agent_gpt, chat_agent_claude_model, get_context_chat_messages_for_claude
...
@router.post("/gpt-model", responses={
